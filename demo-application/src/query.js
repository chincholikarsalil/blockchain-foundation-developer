...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var walletPath, wallet, gateway, connectionProfilePath, connectionProfile, connectionOptions, network, contract, result, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, contract.evaluateTransaction('readMyAsset', '002')];
                case 4:
                    result = _a.sent();
